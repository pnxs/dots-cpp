...
{
    EXPECT_EQ(m_sut.serialize(SerializationStructSimple1.int32Property), data_t({ CBOR_INT32_POSITIVE }));
    EXPECT_EQ(m_sut.serialize(SerializationStructSimple1.stringProperty), data_t({ CBOR_STRING_1 }));
    EXPECT_EQ(m_sut.serialize(SerializationStructSimple1.float32Property), data_t({ CBOR_FLOAT32_POSITIVE }));
}
...
TEST_F(TestExperimentalCborSerializer, serialize_VectorArgument)
{
    ...
    EXPECT_EQ(m_sut.serialize(VectorStructSimple), data_t({ 0x82, 0x81, 0x02, CBOR_INT32_POSITIVE, 0x81, 0x08, CBOR_BOOL_FALSE }));
}
...
TEST_F(TestExperimentalCborSerializer, deserialize_VectorArgument)
{
    ...
    m_sut.deserialize(data_t({ 0x82, 0x81, 0x02, CBOR_INT32_POSITIVE, 0x81, 0x08, CBOR_BOOL_FALSE }), vectorStructSimple);
...
TEST_F(TestExperimentalCborSerializer, deserialize_SimpleStructArgument)
{
    ...
    m_sut.deserialize(data_t{ 0x83, 0x16, CBOR_INT32_POSITIVE, CBOR_STRING_1, CBOR_FLOAT32_POSITIVE }, serializationStructSimple1);
    EXPECT_EQ(serializationStructSimple1, SerializationStructSimple1);

    SerializationStructSimple serializationStructSimple2;
    m_sut.deserialize(data_t{ 0x81, 0x10, CBOR_FLOAT32_POSITIVE }, serializationStructSimple2);
...
TEST_F(TestExperimentalCborSerializer, deserialize_ComplexStructArgument)
{
    ...
    m_sut.deserialize(data_t{ 0x84, 0x1A, 0x02, 0x00, 0x80, 0x90, CBOR_TEST_ENUM_1, CBOR_FLOAT64_NEGATIVE, CBOR_TIME_POINT_1, 0x81, 0x08, CBOR_BOOL_FALSE }, serializationStructComplex1);
    EXPECT_EQ(serializationStructComplex1, SerializationStructComplex1);

    SerializationStructComplex serializationStructComplex2;
    m_sut.deserialize(data_t{ 0x83, 0x19, 0x02, 0x48, CBOR_PROPERTY_SET_MIXED_1, 0x82, CBOR_DURATION_1, CBOR_DURATION_2, CBOR_UUID_1 }, serializationStructComplex2);
    EXPECT_EQ(serializationStructComplex2, SerializationStructComplex2);

    SerializationStructComplex serializationStructComplex3;
    m_sut.deserialize(data_t{ 0x81, 0x1A, 0x02, 0x00, 0x00, 0x00, CBOR_TIME_POINT_1 }, serializationStructComplex3);
    ...
    m_sut.deserialize(data_t{ 0x81, 0x19, 0x02, 0x00, 0x82, CBOR_DURATION_1, CBOR_DURATION_2 }, serializationStructComplex4);
