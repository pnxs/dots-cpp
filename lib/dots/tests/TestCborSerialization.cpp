...
TEST(TestCborSerialization, deserialize)
{
...

    {
        ...
        auto properties = StructDescriptorData::name_t::PropertySet() + StructDescriptorData::properties_t::PropertySet() + StructDescriptorData::documentation_t::PropertySet();
